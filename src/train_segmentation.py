...
from networks import WMIDNet, MFGANet
from data import WMIDDataset
...
def get_data(input_images: str, input_logos: str,
			 split: float = 0.25, batch_size=4, workers: int = 0) -> (DataLoader, DataLoader):
	data = WMIDDataset(input_images, input_logos)
